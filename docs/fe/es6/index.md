...
log('jeffery', 1, 2) // jeffery [1, 2]
log('jeffery', 1, 2, 3) // jeffery [1, 2, 3]
```
...
// 字符串会以字符数组的形式做合并
Object.assign({}, 'jeffery') // {0: 'm', 1: 'a', 2: 'o', 3: 'm', 4: 'a', 5: 'o'}
...
```js
const obj = { name: 'jeffery', age: 18 }
Object.keys(obj) // ['name', 'age']
Object.values(obj) //  ['jeffery', 18]
Object.entries(obj) // [['name', 'jeffery'], ['age', 18]]
```
...
```js
Object.fromEntries([['name', 'jeffery']]) // {name: 'jeffery'}

/* Map 转对象 */
const map = new Map([['name', 'jeffery']])
Object.fromEntries(map) // {name: 'jeffery'}

/* 将查询字符串转为对象 */
const params = 'name=jeffery&age=18'
Object.fromEntries(new URLSearchParams(params)) // {name: 'jeffery', age: '18'}
```
...
[Promise 实现](https://github.com/jeffery1996/Promise) 简易实现、A+ 规范实现、原型方法、静态方法实现
