...
// 对象实例
const person1 = new Person('jeffery')
console.log(person1) // Person {name: 'jeffery'}
```
...
console.log(person1.name, person2.name) // 'jeffery' 'jeffery'
```
...
// 对象实例
const person = new Person('jeffery')
