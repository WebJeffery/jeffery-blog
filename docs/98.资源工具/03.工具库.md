...
- [Homebrew 软件包](https://brew.sh/index_zh-cn)
- [oh-my-shell美化工具](https://ohmyz.sh/#install)
- [iterm2 shell命令行](https://iterm2.com/features.html)
- [nvm - node版本管理工具](https://github.com/nvm-sh/nvm)
## 前端常用
